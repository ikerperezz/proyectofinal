	...
	public VentanaMercado() {
		...
		btnOferta.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int value = ((int) spinner_1.getValue() * 10000000) + ((int) spinner_2.getValue() * 1000000)
						+ ((int) spinner_3.getValue() * 100000) + ((int) spinner_1_1.getValue() * 10000)
						+ ((int) spinner_2_1.getValue() * 1000) + ((int) spinner_3_1.getValue() * 100)
						+ ((int) spinner_2_1_1.getValue() * 10) + ((int) spinner_1_1_1.getValue() * 1);
				...
				if (!(list.getSelectedIndex() == -1)) {
					...
					if (value > valor) {
						...
						JOptionPane.showMessageDialog(VentanaMercado.this, "Oferta realizada");
					} else {
						JOptionPane.showMessageDialog(VentanaMercado.this, "La oferta es menor al valor");
					}
				} else {
					JOptionPane.showMessageDialog(VentanaMercado.this, "No hay ningun jugador seleccionado");
				}
